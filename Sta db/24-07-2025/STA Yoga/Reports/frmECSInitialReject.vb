Imports System.Data
Public Class frmECSInitialReject
    ...
    Private Sub cboFileName_GotFocus(sender As Object, e As EventArgs) Handles cboFileName.GotFocus
        ...
        lsSql &= " and file_type in (" & gnFileECSRejectFile & ") "
    ...
    Private Sub LoadGrid()
        ...
        If mnFolioId > 0 Then lsCond &= " and a.ecsvalidationstatus_gid = " & mnFolioId & " "
        ...
        lsSql &= " e.status_desc as 'Status',"
        lsSql &= " a.ecsvalidationstatus_gid as 'ECS Status Id' "
        lsSql &= " from sta_trn_tecsvalidationstatus as a "
        ...
        lsSql &= " inner join sta_mst_tstatus as e on a.ecsvalidation_status=e.status_value and e.status_type='Ecs Validation' and e.delete_flag='N' "
        lsSql &= " where true "
        lsSql &= lsCond
        lsSql &= " and a.ecsvalidation_status=256 and a.delete_flag = 'N' "
        lsSql &= " order by a.ecsvalidationstatus_gid asc"
    ...
    Private Sub dgvList_KeyDown(sender As Object, e As KeyEventArgs) Handles dgvList.KeyDown
        ...
        With dgvList
            If .CurrentCell.RowIndex >= 0 Then
                lnFolioId = .CurrentRow.Cells("ECS Status Id").Value
