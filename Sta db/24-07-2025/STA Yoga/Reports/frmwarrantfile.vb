...
Public Class frmwarrantfile
    ...
    Private Sub LoadGrid()
        ...
        lsSql = ""
        lsSql &= " select "
        lsSql &= " a.folioclient_dp_id as 'DPID',"
        lsSql &= " a.folioclient_id as 'FOLIO',"
        lsSql &= " a.holder1_name as 'NAME',"
        lsSql &= " a.holder1_addr1 as 'ADD1',"
        lsSql &= " a.holder1_addr2 as 'ADD2',"
        lsSql &= " a.holder1_addr3 as 'ADD3',"
        lsSql &= " a.holder1_city as 'CITY',"
        lsSql &= " a.holder1_state as 'STATE',"
        lsSql &= " a.holder1_country as 'COUNTRY',"
        lsSql &= " a.holder1_pincode as 'PIN',"
        lsSql &= " d.share_count as 'SHARE',"
        lsSql &= " a.payment_ref_no as 'WARNO',"
        lsSql &= " '' as 'WAR_MICR',"
        lsSql &= " a.dividend_amount as 'NET',"
        lsSql &= " e.bankacctype_name as 'TYPE',"
        lsSql &= " a.Payment_gid as 'GNSA Ref Id' "
        lsSql &= " from sta_trn_tpayment as a "
        lsSql &= " inner join sta_mst_tcompany as b on a.comp_gid = b.comp_gid and a.payment_mode='W' and b.delete_flag = 'N'  "
        lsSql &= " inner join sta_trn_tdividend as d on a.dividend_gid = d.dividend_gid and d.delete_flag='N' "
