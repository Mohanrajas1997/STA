Public Class frmFolioDebarrtPanReport

    Private Sub frmFolioDebarrtPanReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim lsSql As String
    ...
    Private Sub frmFolioDebarrtPanReport_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
        pnlMain.Top = 6
        pnlMain.Left = 6
    ...
    Private Sub LoadData()
        ...
        lsSql &= " inner join sta_trn_tdebarrtorderdtl as c on a.holder1_pan_no = c.pan_no and c.delete_flag = 'N' and c.debarrt_flag = 'Y' "
        ...
        If txtPanno.Text <> "" Then lsCond &= " and a.holder2_pan_no like '" & QuoteFilter(txtPanno.Text) & "%' "
        ...
        lsSql &= " from sta_trn_tfolio as a "
        lsSql &= " inner join sta_mst_tcompany as b on a.comp_gid = b.comp_gid and b.delete_flag = 'N' "
        lsSql &= " inner join sta_trn_tdebarrtorderdtl as c on a.holder2_pan_no = c.pan_no and c.delete_flag = 'N' and c.debarrt_flag = 'Y' "
        lsSql &= " inner join sta_trn_tdebarrtorder as d on c.debarrtorder_gid = d.debarrtorder_gid and d.delete_flag = 'N' and d.debarrt_flag = 'Y' "
        lsSql &= " where true "
        lsSql &= lsCond
        lsSql &= " and a.delete_flag = 'N') "
        ...
        If txtFolioNo.Text <> "" Then lsCond &= " and a.folio_no like '" & QuoteFilter(txtFolioNo.Text) & "%' "
        If txtHoldername.Text <> "" Then lsCond &= " and a.holder3_name like '" & QuoteFilter(txtHoldername.Text) & "%' "
        If txtPanno.Text <> "" Then lsCond &= " and a.holder3_pan_no like '" & QuoteFilter(txtPanno.Text) & "%' "
        ...
        lsSql &= " from sta_trn_tfolio as a "
        lsSql &= " inner join sta_mst_tcompany as b on a.comp_gid = b.comp_gid and b.delete_flag = 'N' "
        lsSql &= " inner join sta_trn_tdebarrtorderdtl as c on a.holder3_pan_no = c.pan_no and c.delete_flag = 'N' and c.debarrt_flag = 'Y' "
        lsSql &= " inner join sta_trn_tdebarrtorder as d on c.debarrtorder_gid = d.debarrtorder_gid and d.delete_flag = 'N' and d.debarrt_flag = 'Y' "
        lsSql &= " where true "
        lsSql &= lsCond
        lsSql &= " and a.delete_flag = 'N') "
