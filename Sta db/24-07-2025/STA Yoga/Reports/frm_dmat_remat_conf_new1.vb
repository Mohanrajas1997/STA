...
Public Class frm_dmat_remat_conf_new1
    ...
    Private Sub frm_dmat_remat_conf_new1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Mysql &= " where delete_flag = 'N' and depository_code <> 'A'"
    ...
    Private Sub frmUploadSummary_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        ...
        btnpdf.Left = btnExport.Left - btnpdf.Width - 6
    End Sub
    ...
    Private Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        ...
        If File.Exists(fileloc) Then
            ...
            Using sw As StreamWriter = New StreamWriter(fileloc)
                sw.WriteLine("Unit : " & comp_txt & "   -    " & cbotype.Text.ToUpper() & "   " & vbTab & vbTab & vbTab & vbTab & "Date : " & todaysdate)
                sw.WriteLine(" ")
                sw.WriteLine("LIST OF CASES CONFIRMED TO " & dep_txt & "  FROM  " & lsCond3 & "  TO  " & lsCond4 & "            ")
                sw.WriteLine("===================================================================================================================================== ")
                sw.WriteLine("Folio No " & vbTab & "Drnno " & vbTab & vbTab & "Gnsainwdno" & " Dist From " & vbTab & buf & "Dist To " & vbTab & buf & "Cert no " & vbTab & "  Shares " & vbTab & buf & "Approved_date ")
                sw.WriteLine("===================================================================================================================================== ")
                For Each row As DataRow In dt.Rows
                    sw.WriteLine(row("Folio").ToString() & vbTab & row("Drn_no").ToString() & vbTab & vbTab & row("Gnsa_inward_no").ToString() & vbTab & buf & row("DistNo_From").ToString().PadRight(10, " ") & vbTab & buf & row("DistNo_To").ToString().PadRight(10, " ") & vbTab & buf & row("Certificate_no").ToString().PadRight(8, " ") & buf & vbTab & row("shares").ToString().PadLeft(8, " ") & vbTab & buf & row("Approved_date").ToString())
                Next
                If dt.Rows.Count = 0 Then
                    sw.WriteLine("              ---------------------------------------------------- NILL ----------------------------------------------------              ")
                End If
                sw.WriteLine("===================================================================================================================================== ")
                sw.WriteLine(vbTab & vbTab & vbTab & vbTab & vbTab & vbTab & vbTab & vbTab & vbTab & buf & buf & vbTab & " Total :    " & sum_txt)
                sw.WriteLine("===================================================================================================================================== ")
            End Using
        End If
    ...
    Private Sub btnpdf_Click(sender As Object, e As EventArgs) Handles btnpdf.Click
        ...
        Try
            ...
            If File.Exists(fileloc) Then
                Using sw As StreamWriter = New StreamWriter(fileloc)
                    sw.WriteLine("Unit : " & comp_txt & "   -    " & cbotype.Text.ToUpper() & "   " & space & space & space & space & "Date : " & todaysdate)
                    sw.WriteLine(" ")
                    sw.WriteLine("LIST OF CASES CONFIRMED TO " & dep_txt & "  FROM  " & lsCond3 & "  TO  " & lsCond4 & "            ")
                    sw.WriteLine("============================================================================================================ ")
                    sw.WriteLine(" Folio No " & space & "   Drnno " & space & " Gnsainwdno " & "  Dist From " & space & "Dist To " & space & "  Cert no " & space & "  Shares" & space & "Approved_date ")
                    sw.WriteLine("============================================================================================================ ")
                    If cbdepotype.Text = "CDSL" Then
                        For Each row As DataRow In dt.Rows
                            sw.WriteLine(row("Folio").ToString() & space & space & row("Drn_no").ToString() & space & row("Gnsa_inward_no").ToString() & space & space & row("DistNo_From").ToString().PadRight(10, " ") & space & row("DistNo_To").ToString().PadRight(10, " ") & space & row("Certificate_no").ToString().PadRight(8, " ") & space & row("shares").ToString().PadLeft(8, " ") & space & row("Approved_date").ToString())
                        Next
                        If dt.Rows.Count = 0 Then
                            sw.WriteLine("              --------------------------------------- NILL ---------------------------------------              ")
                        End If
                    ...
                    If cbdepotype.Text = "NSDL" Then
                        For Each row As DataRow In dt.Rows
                            sw.WriteLine(row("Folio").ToString() & space & row("Drn_no").ToString() & space & row("Gnsa_inward_no").ToString() & space & space & row("DistNo_From").ToString().PadRight(10, " ") & space & row("DistNo_To").ToString().PadRight(10, " ") & space & row("Certificate_no").ToString().PadRight(8, " ") & space & row("shares").ToString().PadLeft(8, " ") & space & row("Approved_date").ToString())
                        Next
                        If dt.Rows.Count = 0 Then
                            sw.WriteLine("              --------------------------------------- NILL ---------------------------------------              ")
                        End If
                    ...
                    sw.WriteLine("============================================================================================================ ")
                    If cbdepotype.Text = "NSDL" Then
                        sw.WriteLine(space & space & space & space & space & space & space & space & space & space & space & space & space & space & space & space & space & space & space & space & " Total : " & sum_txt)
                    End If
                    If cbdepotype.Text = "CDSL" Then
    ...
    Private Sub btnDRNotepad_Click(sender As Object, e As EventArgs) Handles btnDRNotepad.Click
        dgvList.DataSource = Nothing
        Dim ls_txt As String
        Dim dtxt As System.Data.DataTable
        Dim ds As New DataSet
        ...
        If File.Exists(fileloc) Then
            Using sw As StreamWriter = New StreamWriter(fileloc, False)
                sw.WriteLine("Unit : " & comp_txt & "   -    " & cbotype.Text.ToUpper() & "   " & vbTab & vbTab & vbTab & vbTab & "Date : " & todaysdate)
                sw.WriteLine(" ")
                sw.WriteLine("LIST OF CASES CONFIRMED TO " & dep_txt & "  FROM  " & lsCond3 & "  TO  " & lsCond4 & "            ")
                sw.WriteLine("===================================================================================================================================== ")
    ...
    Private Sub btnDRpdf_Click(sender As Object, e As EventArgs) Handles btnDRpdf.Click
        dgvList.DataSource = Nothing
