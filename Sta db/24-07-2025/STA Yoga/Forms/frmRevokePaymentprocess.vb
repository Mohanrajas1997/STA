...
Public Class frmRevokePaymentprocess
    Private Sub frmQueue_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'Paymode
        lsSql = ""
        lsSql &= " select paymode_desc,paymode_code from sta_mst_tpaymode "
        lsSql &= " where delete_flag ='N' "
        lsSql &= " order by paymode_desc asc "
    ...
    Private Sub btnGenerate_Click(sender As System.Object, e As System.EventArgs) Handles btnGenerate.Click
        ...
        Try
            ...
            If CboPaymode.SelectedIndex <> -1 Then
                lnpaymode = CboPaymode.SelectedValue.ToString
            Else
                lnpaymode = ""
            End If


            Using cmd As New MySqlCommand("pr_sta_revoke_tpaymentgeneration", gOdbcConn)
                ...
                cmd.Parameters.AddWithValue("?in_payment_mode", lnpaymode)
                cmd.Parameters.AddWithValue("?in_insert_by", gsLoginUserCode)
