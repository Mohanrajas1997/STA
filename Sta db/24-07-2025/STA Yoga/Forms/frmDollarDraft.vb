...
Public Class frmDollarDraft
    ...
    Private Sub LoadGrid()
        ...
        lsSql &= " ''  as 'CURRENCY VALUE',"
        lsSql &= " ''  as 'CURRENCY AMOUNT',"
        lsSql &= " a.Payment_gid as 'GNSA Ref Id' "
        lsSql &= " from sta_trn_tpayment as a "
        lsSql &= " inner join sta_mst_tcompany as b on a.comp_gid = b.comp_gid and a.payment_mode='F' and b.delete_flag = 'N'  "
