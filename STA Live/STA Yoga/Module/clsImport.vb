...
Public Class clsImport
    ...
    Public Function BenpostNSDL_old(FileName As String, Optional ShowFlag As Boolean = True, Optional LsvItem As ListViewItem = Nothing) As clsFileReturn
        Dim i As Integer
        Dim j As Integer
        Dim c As Integer = 0
        Dim d As Integer = 0
    ...
    Public Function BenpostCDSL_old(FileName As String, Optional ShowFlag As Boolean = True, Optional LsvItem As ListViewItem = Nothing) As clsFileReturn
        Dim i As Integer
        Dim j As Integer
        Dim c As Integer = 0
        Dim d As Integer = 0
