...
Public Class frmDebarrtReleaseEntry
    ...
    Private Sub btnFind_Click(sender As Object, e As EventArgs) Handles btnFind.Click
        ...
        Try
            SearchDialog = New frmSearch(gOdbcConn, _
                         ...
                         " a.delete_flag='N' and a.debarrt_flag = 'N' ")
            ...
            If Val(gnSearchId) <> 0 Then
                Call ListAll("select a.debarrtorder_gid,a.debarrtorder_no,a.debarrtorder_date,a.debarrtorder_remark from sta_trn_tdebarrtorder as a" _
                             ...
                             & " and a.delete_flag = 'N' and a.debarrt_flag = 'N' ", gOdbcConn)
            End If
        ...
        Try
            ...
            With ds.Tables("list_all")
                If .Rows.Count > 0 Then
                    ...
                    gsqry &= " inner join sta_trn_tdebarrtorderdtl b on b.debarrtorder_gid = a.debarrtorder_gid and b.delete_flag = 'N' and b.debarrt_flag = 'N' "
                    gsqry &= " where a.debarrtorder_gid=" & txtorder_Id.Text
                    gsqry &= " and a.delete_flag='N' and a.debarrt_flag = 'N' "
