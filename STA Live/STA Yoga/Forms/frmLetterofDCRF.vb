...
Public Class frmLetterofDCRF
    ...
    Private Sub frmLetterofDCRF_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim lsSql As String
        Dim csSql As String
        ...
        Using da As New MySqlDataAdapter(lsSql, gOdbcConn)
    ...
    Private Sub dgv_covering_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv_covering.CellContentClick
        ...
        If e.ColumnIndex = 16 Then
            ...
            Dim inputFile As String = "c:\STA EXE\DCRF_Template.rtf"
            Dim shsql As String
            Dim ds1 As DataSet
            ...
            ds1 = New DataSet
            Call gpDataSet(shsql, "DCRF", gOdbcConn, ds1)

            With ds1.Tables("DCRF")
                If .Rows.Count > 0 Then
                    ...
                    fileReader = fileReader.Replace("<<trantype_desc>>", .Rows(0).Item("trantype_desc").ToString)
            ...
            Dim outputFile As String = "C:\DCRF_DRF"
            ...
            outputFile = Path.ChangeExtension(outputFile + "\DCRF(or)DRF.rtf", ".rtf")
