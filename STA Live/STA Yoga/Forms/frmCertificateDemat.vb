...
#End Region
    ...
    Private Sub LoadData()
        ...
        With dgvChklst
            ...
            If mnChkLstAllStatus = lnChkLstValid And Val(lblShareSelected.Text) = Val(txtSharesDrn.Text) Then
    ...
    Private Sub RefreshShareCount()
        ...
        With dgvCert
            ...
            If mnChkLstAllStatus = mnChklstValid And Val(lblShareSelected.Text) = Val(txtSharesDrn.Text) Then
                lblDocStatus.Text = "Valid"
                lblDocStatus.ForeColor = Color.DarkGreen
            Else
                lblDocStatus.Text = "Invalid"
