...
Public Class frmECSInitialRejectImport
    ...
    Private Sub SetInitializeDefaultData()
        ...
        lsSql &= " where true "
        lsSql &= " and file_type =  'ECS Bounce File' "
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        Dim i As Integer
        Dim lsFileType As String = "ECS Reject File Import"
            ...
            With lsvFile
                For i = 0 To .Items.Count - 1
                    ...
                    If lobjItem.Checked = True Then
                        ...
                        If lsFileType.ToUpper = "ECS REJECT FILE IMPORT" Then
                            objFileReturn = objImp.ECSRejectFileImport(lsFile, lsSheetName, lsCompany, lsFinYear, lsInterimCode, False, lobjItem)
                        End If
