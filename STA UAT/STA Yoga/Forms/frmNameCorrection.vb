...
#End Region
    ...
    Private Sub LoadData()
        ...
        cmd = New MySqlCommand("pr_sta_get_folioentryholder", gOdbcConn)
        ...
        With dt
            If .Rows.Count > 0 Then
                ...
                txtCurrSH1.Text = .Rows(0).Item("curr_holder1_name").ToString
                txtCurrSH2.Text = .Rows(0).Item("curr_holder2_name").ToString
                txtCurrSH3.Text = .Rows(0).Item("curr_holder3_name").ToString

                txtNewSH1.Text = .Rows(0).Item("new_holder1_name").ToString
                txtNewSH2.Text = .Rows(0).Item("new_holder2_name").ToString
                txtNewSH3.Text = .Rows(0).Item("new_holder3_name").ToString

                If txtCurrSH2.Text = "" Then txtNewSH2.Enabled = False
                If txtCurrSH3.Text = "" Then txtNewSH3.Enabled = False
    ...
    Private Sub UpdateInformation(ActionStatus As Integer)
        ...
        Dim lsNewSH1 As String
        Dim lsNewSH2 As String
        Dim lsNewSH3 As String

        Dim lsRemark As String

        Try
            lsNewSH1 = QuoteFilter(txtNewSH1.Text)
            lsNewSH2 = QuoteFilter(txtNewSH2.Text)
            lsNewSH3 = QuoteFilter(txtNewSH3.Text)
            ...
            Using cmd As New MySqlCommand("pr_sta_set_folioentryholder", gOdbcConn)
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.AddWithValue("?in_inward_gid", mnInwardId)
                cmd.Parameters.AddWithValue("?in_holder1_name", lsNewSH1)
                cmd.Parameters.AddWithValue("?in_holder2_name", lsNewSH2)
                cmd.Parameters.AddWithValue("?in_holder3_name", lsNewSH3)
