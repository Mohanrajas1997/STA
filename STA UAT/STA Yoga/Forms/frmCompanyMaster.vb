...
Public Class frmCompanyMaster
    ...
    Private Sub lblPincode_Click(sender As Object, e As EventArgs) Handles lblPincode.Click
    ...
    Private Sub lblCity_Click(sender As Object, e As EventArgs) Handles lblCity.Click
    ...
    Private Sub lblAddress3_Click(sender As Object, e As EventArgs) Handles lblAddress3.Click
    ...
    Private Sub lblAddress2_Click(sender As Object, e As EventArgs) Handles lblAddress2.Click
    ...
    Private Sub lblAddress1_Click(sender As Object, e As EventArgs) Handles lblAddress1.Click

    End Sub

    Private Sub Label2_Click(sender As Object, e As EventArgs) Handles lblcin_no.Click

    End Sub

    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles txtPanNo.TextChanged

    End Sub

    Private Sub Label1_Click(sender As Object, e As EventArgs) Handles lblPanNo.Click
