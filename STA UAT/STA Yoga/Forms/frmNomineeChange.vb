...
#End Region
    ...
    Private Sub LoadData()
        ...
        cmd = New MySqlCommand("pr_sta_get_folioentrynominee", gOdbcConn)
        ...
        With dt
            If .Rows.Count > 0 Then
                ...
                txtCurrRegNo.Text = .Rows(0).Item("curr_reg_no").ToString
                txtCurrNomineeName.Text = .Rows(0).Item("curr_name").ToString
                ...
                txtNewRegNo.Text = .Rows(0).Item("new_reg_no").ToString
                txtNewNomineeName.Text = .Rows(0).Item("new_name").ToString
    ...
    Private Sub UpdateInformation(ActionStatus As Integer)
        ...
        Try
            lsRegNo = QuoteFilter(txtNewRegNo.Text)
            lsName = QuoteFilter(txtNewNomineeName.Text)
            ...
            Using cmd As New MySqlCommand("pr_sta_set_folioentrynominee", gOdbcConn)
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.AddWithValue("?in_inward_gid", mnInwardId)
                cmd.Parameters.AddWithValue("?in_nominee_reg_no", lsRegNo)
                cmd.Parameters.AddWithValue("?in_nominee_name", lsName)
                cmd.Parameters.AddWithValue("?in_nominee_addr1", lsAddr1)
                cmd.Parameters.AddWithValue("?in_nominee_addr2", lsAddr2)
                cmd.Parameters.AddWithValue("?in_nominee_addr3", lsAddr3)
                cmd.Parameters.AddWithValue("?in_nominee_city", lsCity)
                cmd.Parameters.AddWithValue("?in_nominee_state", lsState)
                cmd.Parameters.AddWithValue("?in_nominee_country", lsCountry)
                cmd.Parameters.AddWithValue("?in_nominee_pincode", lsPincode)
