...
Public Class frmMain
    ...
    Private Sub frmMain_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'Timer1.Interval = 120000 ' 2 minutes
        'Timer1.Start()
        Call Main()
    ...
    Private Sub DebarrtOrderReportToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DebarrtOrderReportToolStripMenuItem.Click
        Dim frm As New frmDebarrtOrderReport
        frm.MdiParent = Me
        frm.Show()
    End Sub

    Private Sub DebartPanReleasePanReportToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DebartPanReleasePanReportToolStripMenuItem.Click
    ...
    Private Sub mnuInwardDocsubtypeRptToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles InwardDocsubtypeRptToolStripMenuItem_Click.Click
    ...
    Private Sub ISRGenerateCoveringLetterToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ISRGenerateCoveringLetterToolStripMenuItem.Click
