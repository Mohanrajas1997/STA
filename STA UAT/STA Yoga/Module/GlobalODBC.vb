...
#Region "Global Declaration"
    ...
    'Added by Mangai 21-10-2025
    'Public gsiepfApprovetemplatepath As String = "c:\temp\Entitlement letter.rtf"
    ...
    Public gnInwardFolioFreeze As Integer = 128
...
#End Region
    ...
    Public Sub Main()
        ...
        Else
            ...
            'ServerDetails = "Server=146.56.55.230;DataBase=sta;uid=root;pwd=Flexi@123;port=3306;default command timeout = 0;"
            ServerDetails = "Server=146.56.55.230;DataBase=sta;uid=root;pwd=Flexi@123;port=3306;Pooling=true;Connection Timeout = 30;default command timeout = 0;"
            ...
            For n = 0 To .Rows.Count - 1
                ...
                If lsTxt <> "" Then
                    Select Case .Rows(n).Item("config_name").ToString.ToUpper
                        ...
                        Case "SMSAPIURL"
                            gsApiUrl = lsTxt
                        Case "IEPF APPROVE LS"
                            gsiepfApproveLStemplatepath = lsTxt
                        Case "IEPF APPROVE TM"
                            gsiepfApproveTMtemplatepath = lsTxt
                        Case "IEPF REJECT"
                            gsiepfRejectiontemplatepath = lsTxt
                    End Select
                End If
            Next n
        End With
