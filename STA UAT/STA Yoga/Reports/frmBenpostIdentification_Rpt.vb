    ...
    Private Sub LoadData()
        ...
        Try
            ...
            If cboDeposit.Text = "ALL" Or cboDeposit.Text = "" Then
                ...
                lsSql &= " case when sum(cdsl)>0 then 'Received' when depository_code = 'NSDL' then ' - '  else 'Not Received' end as 'CDSL Status',"
                lsSql &= " case when sum(nsdl)>0 then 'Received' when depository_code = 'CDSL' then ' - ' else 'Not Received' end as 'NSDL Status'"
                lsSql &= " from ("
            ...
            ElseIf cboDeposit.Text = "CDSL" Or cboDeposit.Text = "NSDL" Then
                lsSql &= " select distinct a.comp_gid,a.comp_code as 'Company Code',a.comp_short_code as 'Company Short Code',a.comp_name as 'Company Name',"
                lsSql &= " a.isin_id as 'ISIN Id'," & "'" & cboDeposit.Text & "' as 'Type'"
                ...
                lsSql &= " and ifnull(b.comp_gid,0) > 0 and a.delete_flag='N';"
