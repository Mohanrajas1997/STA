...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cboFileType.Location = New System.Drawing.Point(470, 39)
        ...
        Me.dgvReport.Location = New System.Drawing.Point(6, 125)
        Me.dgvReport.Name = "dgvReport"
        Me.dgvReport.ReadOnly = True
        Me.dgvReport.Size = New System.Drawing.Size(754, 178)
...
#End Region
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            If cboFileType.Text <> "" And cboFileType.SelectedIndex >= 0 Then lsCond &= " and a.file_type = '" & QuoteFilter(cboFileType.SelectedValue.ToString) & "' "
            ...
            lsFld &= " a.file_remark as 'Remark',a.insert_by as 'Import By',"
            lsFld &= " a.file_type as 'File Type',f.file_desc as 'File Desc',"
