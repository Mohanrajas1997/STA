...
Public Class frmIEPFreport
    ...
    Private Sub LoadIEPF1Grid()
        ...
        lsSql = ""
        lsSql &= " select SUBSTRING_INDEX(SUBSTRING_INDEX(a.shar_holder, ' ', 1), ' ', -1) AS 'First Name',"
        lsSql &= " SUBSTRING_INDEX(SUBSTRING_INDEX(a.shar_holder, ' ', 2), ' ', -1) AS 'Middle Name',"
        lsSql &= " SUBSTRING(a.shar_holder,LENGTH(SUBSTRING_INDEX(a.shar_holder, ' ', 2))+1) AS 'Last Name',"
        ...
        lsSql &= " end"
        lsSql &= " AS 'Father First Name',"
        lsSql &= " SUBSTRING_INDEX(SUBSTRING_INDEX(b.holder1_fh_name, ' ', 2), ' ', -1) AS 'Father Middle Name',"
        lsSql &= " SUBSTRING(b.holder1_fh_name,LENGTH(SUBSTRING_INDEX(b.holder1_fh_name, ' ', 2))+1) AS 'Father Last Name',"
